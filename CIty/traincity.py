...
logger = Logger('/home/water/桌面/city/log')  #使用我们的Logger！！！
...
def train():
    ...
    for epoch in range(epochs):   #训练500轮
       ...
       # if epoch%5 == 0 : # 每5 epochs 存一下
        ...
        torch.save(fcn_model.state_dict(),'/home/water/桌面/city/pth/sate.pth')
